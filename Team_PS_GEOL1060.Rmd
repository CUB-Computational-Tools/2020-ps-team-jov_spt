...
ML_CO2vsYear_wTrend <- #We create a new plot stored in "ML_CO2vsYear"
...
SSTvsYear <-
ggplot(ModernSST_data, aes(x = year, y = Annual Anomaly)) + 
geom_line(size = 0.5, color = 'black') + 
geom_ribbon(aes(ymin=data$lower, ymax=data$upper)) +
labs(y = ML_y_title, x = "Year", title = bquote("Atmospheric" ~ CO[2] ~ "at Mauna Loa Observatory")) + #
theme_bw()  

SSTvsYear #prints out our plot
```

In the graph above we have plotted 
